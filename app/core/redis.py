...
class RedisManager:
    ...
    def _setup_connection_params(self) -> None:
        ...
        logger.info(f"Redis connection parameters configured for {self._connection_params['host']}:{self._connection_params['port']}")
    ...
    def _create_connection_pool(self) -> None:
        ...
        logger.info(f"Redis connection pool created with max_connections={settings.REDIS_POOL_SIZE}")
...
class RedisSemanticCache:
    ...
    async def clear_all(self) -> bool:
        ...
        try:
            ...
            if cache_ids:
                cache_keys = [f"{self.cache_prefix}{cache_id}" for cache_id in cache_ids]
