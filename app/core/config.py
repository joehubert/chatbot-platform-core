...
class Settings(BaseSettings):
    ...
    PINECONE_INDEX_NAME: str = Field(default="chatbot-knowledge", env="PINECONE_INDEX_NAME")
    ...
    AUTH_SESSION_TIMEOUT_MINUTES: int = Field(default=30, env="AUTH_SESSION_TIMEOUT_MINUTES")
    ...
    COMPLEXITY_THRESHOLD_SIMPLE: float = Field(default=0.3, env="COMPLEXITY_THRESHOLD_SIMPLE")
    COMPLEXITY_THRESHOLD_COMPLEX: float = Field(default=0.7, env="COMPLEXITY_THRESHOLD_COMPLEX")
    RELEVANCE_CONFIDENCE_THRESHOLD: float = Field(default=0.6, env="RELEVANCE_CONFIDENCE_THRESHOLD")
    ...
    @validator("CACHE_SIMILARITY_THRESHOLD")
    ...
    @validator("COMPLEXITY_THRESHOLD_SIMPLE", "COMPLEXITY_THRESHOLD_COMPLEX")
    ...
    @validator("RELEVANCE_CONFIDENCE_THRESHOLD")
    ...
    def get_llm_provider_config(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "azure_openai": {
                ...
                "enabled": bool(self.AZURE_OPENAI_ENDPOINT and self.AZURE_OPENAI_API_KEY),
            },
        }
